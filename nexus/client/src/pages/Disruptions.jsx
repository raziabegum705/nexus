...
export default function Disruptions() {
  ...
  useEffect(() => {
    ...
    socket.on('initial_data', ({ disruptions: d }) => setDisruptions(d))
  ...
  return (
    <div style={{ padding: '24px 32px', minHeight: 'calc(100vh - 60px)' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '24px' }}>
        <div>
          <h1 style={{ fontSize: '24px', fontWeight: 700 }}>◉ Disruption Intelligence</h1>
              ...
              <div key={d.id} className="card" style={{
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ fontSize: '15px', fontWeight: 600, marginBottom: '6px' }}>{d.location}</div>
                    <div style={{ fontSize: '13px', color: 'var(--text2)', marginBottom: '12px' }}>{d.description}</div>
