  ...
  return (
    <div style={{ padding: '24px 32px', minHeight: 'calc(100vh - 60px)' }}>
      <div style={{ marginBottom: '24px' }}>
        <h1 style={{ fontSize: '24px', fontWeight: 700 }}>⬢ Cascade Failure Simulator</h1>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 380px', gap: '24px' }}>
        ...
        <div className="card" style={{ padding: '20px', position: 'relative' }}>
            ...
            {shipments.map(s => {
              ...
              return (
                <g key={s.id} transform={`translate(${pos.x}, ${pos.y})`}
                  ...
                  <text textAnchor="middle" dy="34" fill="rgba(15,23,42,0.6)"
          ...
          {/* Legend */}
          <div style={{ display: 'flex', gap: '20px', marginTop: '8px', fontSize: '12px', color: 'var(--text3)' }}>
            {[
              ['#00c896', 'Low Risk'],
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          {!selected && (
            <div className="card" style={{
              ...
              <div style={{ fontSize: '15px', fontWeight: 600 }}>Select a node to simulate</div>
          ...
          {loading && (
            <div className="card" style={{ padding: '40px', textAlign: 'center' }}>
              ...
              <div style={{ marginTop: '12px', color: 'var(--text2)' }}>Simulating cascade...</div>
            </div>
          )}
